...
object PostProjectRequestEntitySerializer {
  ...
  implicit val postProjectConfigurationDecoder: Decoder[PostProjectConfiguration] = deriveDecoder

  implicit val postProjectRequestDecoder: Decoder[PostProjectRequest] = deriveDecoder
